...
class Test2 implements ActionListener
{
	...
	{	
		...
		label1.add(panel);
              	...
              	label2=new JLabel("Accountant Login");
		
		label2.setBounds(110,20,500,100);
		...
		label3=new JLabel("Type your username and password to access your Dashboard");
		label3.setBounds(70,120,600,50);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==btn2)
		{
			...
			try
			{
				...
				//create query
				String query="Select * from empdata where name=? and emp_password=?";
